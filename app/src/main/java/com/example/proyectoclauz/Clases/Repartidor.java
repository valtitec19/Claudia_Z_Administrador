...
public class Repartidor implements Serializable {
    private String nombre,apellidos,correo,telefono,id,direccion,horario_inicio,horario_fin,tarjeta;
    ...
    public Repartidor(String nombre, String apellidos, String correo, String telefono, String id, String direccion
            , String horario_inicio, String horario_fin, Boolean estado, List<String> entregas, List<String> cobertura,List<String> imagenes,String tarjeta) {
        this.nombre = nombre;
