...
import com.example.proyectoclauz.Activitys.LineasActivity;
import com.example.proyectoclauz.Activitys.NuevaRutaActivity;
import com.example.proyectoclauz.Activitys.VerRutaActivity;
...
public class AdapterRuta extends RecyclerView.Adapter<RutaHolder> implements View.OnClickListener{
    ...
    public AdapterRuta(Context context) {
    ...
    public void onBindViewHolder(@NonNull final RutaHolder holder, final int position) {
        ...
        if(list.get(position).getEstado()){
